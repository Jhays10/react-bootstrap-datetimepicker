...
var DateTimeField = (function (_Component) {
  ...
  function DateTimeField() {
    ...
    this.state = {
      ...
      viewDate: (0, _moment2["default"])(this.props.dateTime || (0, _moment2["default"])(), this.props.format, true).startOf("month"),
      selectedDate: (0, _moment2["default"])(this.props.dateTime || (0, _moment2["default"])(), this.props.format, true),
      inputValue: this.props.dateTime ? (0, _moment2["default"])(this.props.dateTime, this.props.format, true).format(this.resolvePropsInputFormat()) : ''
    };
    ...
    this.componentWillReceiveProps = function (nextProps) {
      ...
      if (nextProps.dateTime !== _this.props.dateTime) {
        var isValidDate = (0, _moment2["default"])(nextProps.dateTime, nextProps.format, true).isValid();
        var date = (0, _moment2["default"])(isValidDate ? nextProps.dateTime : (0, _moment2["default"])(), nextProps.format, true);
        state.viewDate = (0, _moment2["default"])(date, nextProps.format, true).startOf("month");
        state.selectedDate = (0, _moment2["default"])(date, nextProps.format, true);
        state.inputValue = nextProps.dateTime ? (0, _moment2["default"])(nextProps.dateTime, nextProps.format, true).format(nextProps.inputFormat ? nextProps.inputFormat : _this.state.inputFormat) : '';
      }
    ...
    this.onChange = function (event) {
      ...
      var isValidDate = (0, _moment2["default"])(value, _this.state.inputFormat, true).isValid();
      var date = (0, _moment2["default"])(isValidDate ? value : (0, _moment2["default"])(), _this.state.inputFormat, true);

      _this.props.onChange(isValidDate ? date.format(_this.props.format) : '', value);
    ...
    value: function render() {
      return _react2["default"].createElement(
        ...
        _react2["default"].createElement(
          ...
          _react2["default"].createElement("input", _extends({ type: "text", className: "form-control", placeholder: this.props.defaultText, onChange: this.onChange, value: this.state.inputValue }, this.props.inputProps)),
          _react2["default"].createElement(
            "span",
